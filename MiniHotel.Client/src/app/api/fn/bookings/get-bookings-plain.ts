...
export function getBookings$Plain(http: HttpClient, rootUrl: string, params?: GetBookings$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<BookingDto>>> {
